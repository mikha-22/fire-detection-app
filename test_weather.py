# test_weather.py
# A fully independent script to test weather data acquisition from Open-Meteo.
# This script has no dependencies on other project files.
...
# --- All necessary logic is now inside this single file ---

def get_historical_weather_data(latitude: float, longitude: float, timestamp: datetime) -> dict:
    """
    ...
    """
    logging.info("Initializing Open-Meteo client with caching and retry logic...")
    ...
    try:
        responses = openmeteo.weather_api("https://archive-api.open-meteo.com/v1/era5", params=params)
...
def run_weather_test():
    """
    Runs a single, predictable test case.
    """
    print("\n--- Testing Open-Meteo Weather Acquisition ---")

    test_latitude = 0.5336
    test_longitude = 101.4478
    test_timestamp = datetime(2025, 6, 16, 10, 30, 0, tzinfo=pytz.utc)
    ...
    if weather_data and "error" not in weather_data:
        ...
        print(f"Test failed. Received data: {weather_data}")
